...
import { ServiceDetailModal } from "@/components/common/service-detail-modal";
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-brand-brown dark:text-brand-beige text-sm font-medium md:opacity-0 md:group-hover:opacity-100 md:translate-x-[-10px] md:group-hover:translate-x-0 transition-all duration-300 hover:gap-3"
                  >
