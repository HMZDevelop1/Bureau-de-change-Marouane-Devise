      ...
      <div className="container-wide relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-brand-coffee/70 dark:text-brand-beige/55 mb-8 leading-relaxed">
              {t("disclaimer")}
            </p>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder="1000"
                    className="w-full px-4 py-3.5 bg-brand-beige dark:bg-brand-beige/[0.04] border border-brand-brown/10 dark:border-brand-beige/[0.08] rounded-xl text-brand-coffee dark:text-brand-beige placeholder:text-brand-coffee/50 dark:placeholder:text-brand-beige/50 focus:outline-none focus:ring-2 focus:ring-brand-brown/30 focus:border-brand-brown/50 text-lg font-semibold transition-all duration-300"
                  />
                </div>
                ...
                <div className="text-center p-4 rounded-xl bg-brand-coffee/[0.03] dark:bg-brand-beige/[0.03] border border-brand-coffee/[0.04] dark:border-brand-beige/[0.04]">
                  <p className="text-sm text-brand-coffee/60 dark:text-brand-beige/45 mb-1">{t("result")}</p>
                  {result !== null ? (
                    <p className="text-2xl sm:text-3xl font-bold text-brand-brown dark:text-brand-beige">
                      {result.toFixed(2)} <span className="text-base sm:text-lg text-brand-coffee/60 dark:text-brand-beige/45">MAD</span>
                    </p>
                  ) : (
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className={cn(
                      ...
                      amount
                        ...
                        : "bg-brand-coffee/10 dark:bg-brand-beige/[0.04] text-brand-coffee/50 dark:text-brand-beige/55 cursor-not-allowed"
                    )}
                  >
                    {t("calculate")}
                  </button>
                  <button
                    onClick={reset}
                    className="px-4 py-3.5 rounded-xl border border-brand-brown/10 dark:border-brand-beige/[0.08] text-brand-coffee/60 dark:text-brand-beige/45 hover:text-brand-brown hover:border-brand-brown/30 transition-all duration-300"
                    aria-label={t("reset")}
                  >
